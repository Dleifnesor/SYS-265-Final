# w02-setup.ps1
# Run this on W2 (172.16.1.101) as a domain admin.
...
Write-Host ""
Write-Host "============================================"
Write-Host " STEP 3: Test RDP connection to W1"
Write-Host "============================================"

Write-Host "Testing connectivity to W1 on port 3389..."
$tcpTest = Test-NetConnection -ComputerName w01 -Port 3389

if ($tcpTest.TcpTestSucceeded) {
    Write-Host "RDP port 3389 is reachable on W1."
} else {
    Write-Warning "Cannot reach W1 on port 3389. Ensure w01-setup.ps1 has been run on W1."
}
...
Write-Host "  2. Open mstsc and connect to w01 — should succeed"
